...
RUN=$1
CONFIG=/usr/local/polarim/config

export HJET_ROOTFILE="$CONFIG/root/"$RUN".root"
export HJET_DATAFILE="$CONFIG/jet/"$RUN".data"
export HJET_DAQ=""
...
export HJET_CALIB="$CONFIG/calib_${2:-1403.904}.dat"  # Run13
if [ "x"$1 == "x" ] ; then 
